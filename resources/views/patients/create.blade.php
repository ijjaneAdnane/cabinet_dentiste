...
@section('content')
    ...
    <div class="card-body">
        <form action="{{ url('patient') }}" method="post">
            ...
            <input type="number" name="tele" id="tele" class="form-control"></br>
            <label>Adresse</label></br>
            <input type="text" name="addresse" id="addresse" required class="form-control"></br>
