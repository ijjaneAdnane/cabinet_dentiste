...
@section('pageTitle', 'Facture')
@section('content')
    <div class="card-body">
        <a href="{{ url('/facture/create') }}" class="btn btn-primary" title="Add New Seances">
                    ...
                    <tbody>
                        @foreach ($factures as $item)
                            ...
                            <tr
                                ...
                                <td>
                                    <a href="{{ url('/facture' . '/' . $item->id . '/edit') }}" title="Edit facture"><button
                                            class="btn btn-primary btn-sm"><i class="fa fa-edit"
                                                aria-hidden="true"></i></button></a>

                                    <form method="POST" action="{{ url('/facture' . '/' . $item->id) }}"
